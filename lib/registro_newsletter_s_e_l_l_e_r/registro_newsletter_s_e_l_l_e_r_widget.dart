...
class RegistroNewsletterSELLERWidget extends StatefulWidget {
  const RegistroNewsletterSELLERWidget({Key key}) : super(key: key);

  @override
  _RegistroNewsletterSELLERWidgetState createState() =>
      _RegistroNewsletterSELLERWidgetState();
}

class _RegistroNewsletterSELLERWidgetState
    extends State<RegistroNewsletterSELLERWidget> {
