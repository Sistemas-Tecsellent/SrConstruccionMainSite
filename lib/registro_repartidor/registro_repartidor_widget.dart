...
class RegistroRepartidorWidget extends StatefulWidget {
  const RegistroRepartidorWidget({Key key}) : super(key: key);

  @override
  _RegistroRepartidorWidgetState createState() =>
      _RegistroRepartidorWidgetState();
}

class _RegistroRepartidorWidgetState extends State<RegistroRepartidorWidget> {
                            ...
                            children: [
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    20, 0, 20, 25),
                                child: Text(
                                  '¡Únete a la familia de Repartidores\nde Sr. Construcción!',
