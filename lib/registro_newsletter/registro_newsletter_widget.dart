...
class RegistroNewsletterWidget extends StatefulWidget {
  const RegistroNewsletterWidget({Key key}) : super(key: key);

  @override
  _RegistroNewsletterWidgetState createState() =>
      _RegistroNewsletterWidgetState();
}

class _RegistroNewsletterWidgetState extends State<RegistroNewsletterWidget> {
